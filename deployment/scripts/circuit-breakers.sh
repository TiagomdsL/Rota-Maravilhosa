...
kubectl apply -f ../kubernetes/circuit-breakers/cb-prediction-service-uc5-uc6.yaml
kubectl apply -f ../kubernetes/circuit-breakers/cb-prediction-service-uc9-uc10.yaml
